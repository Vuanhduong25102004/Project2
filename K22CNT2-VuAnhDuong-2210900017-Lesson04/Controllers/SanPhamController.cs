...
namespace K22CNT2_VuAnhDuong_2210900017_.Controllers
{
    public class SanPhamController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaSP,TenSP,Gia,Soluong,Mota")] SAN_PHAM sAN_PHAM)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaSP,TenSP,Gia,Soluong,Mota")] SAN_PHAM sAN_PHAM)
        {
            if (ModelState.IsValid)
            {
